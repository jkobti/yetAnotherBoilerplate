...
| Platform | Logging stack (Loki / Promtail)                                                 | ⚙️ Optional | Centralized log aggregation with searchable retention.                                 | `Docs/k8s.md` |
| Platform | Observability stack (Prometheus, Grafana)                                       | ⚙️ Optional | Metrics, dashboards, alerting.                                                         | `Docs/k8s.md` |
